            ...
            <table border="2px">
                ...
                <?php foreach ($liste as $co) { ?>
                    <tr>
                        ...
                        <td><?php echo $co['reponse']; ?></td>
                        <td><?php echo $co['id_reclamation']; ?></td>
                        <td><a href="?delete=<?= $co['id_reclamation']; ?>">Supprimer</a></td>
                        <td><a href="modifierrep.php?id=<?= $co['id']; ?>">Modifier</a></td>
                    </tr>
                <?php } ?>
            </table>
        </div>
        <div>
            <button id="sortBtn">Trier par reponse</button>
        </div>
