...
$id_reclamation = $_GET['id_reclamation'] ?? null; // Récupérer l'ID de la réclamation depuis l'URL

if (isset($_POST["sub"])) {
    $Reponse = new Reponse($_POST['reponse'], $id_reclamation);
            ...
            <div class="form-value">
                <form action="" id="formr" method="post">
                    ...
                    <div class="inputbox">
                        ...
                        <input name="reponse" id="reponse" type="text" size="50">
